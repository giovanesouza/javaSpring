package br.com.recode.projetos.config;
...
import br.com.recode.projetos.servicos.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.formLogin().loginPage("/login").defaultSuccessUrl("/clientes").permitAll();
	...
	// NÃO "COMENTAR" O CÓDIGO ABAIXO - MÉTODO QUE AUTORIZA A CRIPTOGRAFIA
	@Override
